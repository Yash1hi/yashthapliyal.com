      ...
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className={`transition-all duration-700 delay-300 ${loaded ? 'opacity-100' : 'opacity-0 -translate-y-8'}`}>
            <h1 className="font-mono text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
          ...
          <div className={`grid grid-cols-2 gap-2 md:gap-4 transition-all duration-700 delay-500 ${loaded ? 'opacity-100' : 'opacity-0 translate-y-8'}`}>
            <div className="h-40 md:h-64 bg-black"></div>
            <div className="h-64 md:h-80 border border-black"></div>
            <div className="h-64 md:h-80 col-span-2 border border-black bg-[#f1f1f1]">
              <div className="p-6 font-mono">
                <code className="text-xs md:text-sm">
                  <span className="text-gray-500">// My approach to creation</span><br />
                  <span>function createSomethingAmazing() {`{`}</span><br />
                  <span>&nbsp;&nbsp;const technology = ["code", "security", "design"];</span><br />
                  <span>&nbsp;&nbsp;const creativity = ["vision", "innovation", "boldness"];</span><br />
                  <span>&nbsp;&nbsp;return technology.combine(creativity);</span><br />
                  <span>{`}`}</span>
                </code>
              </div>
            </div>
